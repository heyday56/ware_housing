    ...
    <div class="container flex min-h-screen w-fit">
        <div
            ...
            <nav>
                ...
                <div class="mt-4">
                    <h6 class="text-blue-600 text-sm font-bold px-4">Add Product</h6>
                    <ul class="mt-2">
                        <li>
        ...
        <div class="table-container flex-1 p-5 ml-[20px] w-screen">
            <div class="m-3"></div>
            <form class="bg-white rounded-lg p-10" method="post" action="{{ route('products.save') }}">
                @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="category" name="category_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"

    ...
    <div class="container flex min-h-screen w-fit">
        <div
            ...
            <nav>
                ...
                <div class="mt-4">
                    <h6 class="text-blue-600 text-sm font-bold px-4">Add Sales</h6>
                    <ul class="mt-2">
                        <li>
        ...
        <div class="table-container flex-1 p-5 ml-[20px] w-screen">
            <div class="m-3"></div>
            <form class="bg-white rounded-lg p-10" method="post" action="{{ route('sales.insert') }}">
                @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <select id="customer_id" name="customer_id"
                            ...
                            @foreach ($customers as $customer)
                                ...
                                <option value="{{ $customer->id }}" class="text-gray-900 bg-white">{{ $customer->name }}
                                </option>
                            @endforeach
                    ...
                    <div>
                        <label for="sales_status" class="block mb-2 text-sm font-medium text-gray-900">Sales
                            Status</label>
                        <input type="text" id="sales_status" name="sales_status"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
